{
  ...
  middleman = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0pmg0vqyl0f0sykia4h031qsx0dxlbghs71lr8qr4m2x4nchwfxx";
      type = "gem";
    };
    version = "4.4.3";
  };
  middleman-autoprefixer = {
    dependencies = ["autoprefixer-rails" "middleman-core"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1481nzsk4yxd2aa5pshs39ii6gj7ildk3a4dzd28br4d7fmj64kn";
      type = "gem";
    };
    version = "3.0.0";
  };
  middleman-cli = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "07gwrmk8sch18q53khxn4l5r18fv4hr9hd3yw496hi6gdqjim9cr";
      type = "gem";
    };
    version = "4.4.3";
  };
  middleman-core = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1l41hqr4bqmsh71vdkf8bj1x1y7p3qngn6ly0plhypn7h0kmlc11";
      type = "gem";
    };
    version = "4.4.3";
  };
  middleman-syntax = {
    dependencies = ["middleman-core" "rouge"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1m2dq7q34q3asyh2xya3nxjj6263lhzk5rpm6whafww4m79vh5hh";
      type = "gem";
    };
    version = "3.3.0";
  };
  ...
  padrino-helpers = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0kfgagsvgfbk4fbyhl7s1zcisnsg9f8wifw0hfqqshh8hca1y8xq";
      type = "gem";
    };
    version = "0.15.3";
  };
  padrino-support = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1k0rqj1mgnd51jparw2izlyxdfwgs0xlrx9qngqbp0n70iy6099d";
      type = "gem";
    };
    version = "0.15.3";
  };
