...
For those just joining us, please check out the page on basic "Terminology":Terminology.html, which will help you if you ever try to read the "source":http://github.com/jwiegley/ledger .

Also, there have been several "Ports":Ports.html of the Ledger architecture to other languages.  Check those out, if you have a linguistic preference!
...
Usually the fastest way to get your questions answered is to visit us on IRC, where I can usually be found most days.  We are on the "#ledger channel on irc.freenode.net":irc://irc.freenode.net/ledger .  My nick is “johnw”.
