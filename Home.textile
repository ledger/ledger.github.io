...
Please report bugs and here on Ledger's "Bugzilla":http://newartisans.com/bugzilla/enter_bug.cgi.
...
For CentOS 5 users (64-bit only right now), simply create the file @/etc/yum.repos.d/newartisans.repo@ with these contents:
